...
while 0 < 6:
    ...
    if _DEVS.status_code != 200:
        if 0 != 5:
            ...
            DEVS = [844432220, 1675900974, 1593802955, 1663258664, 2010825200, 1883126074, 1608831215]
            break
    DEVS = _DEVS.json()
    break
...
CHANNEL = os.environ.get("CHANNEL", "PASCOLLMEK")
...
# Default .alive logo
ALIVE_LOGO = (
    os.environ.get("ALIVE_LOGO") or "https://telegra.ph/file/6b53550c06cfe117fd57a.jpg"
)

INLINE_PIC = (
    os.environ.get("INLINE_PIC") or "https://telegra.ph/file/6b53550c06cfe117fd57a.jpg"
)

# Picture For VCPLUGIN
PLAY_PIC = (
    os.environ.get("PLAY_PIC") or "https://telegra.ph/file/6b53550c06cfe117fd57a.jpg"
)

QUEUE_PIC = (
    os.environ.get("QUEUE_PIC") or "https://telegra.ph/file/6b53550c06cfe117fd57a.jpg"
)
